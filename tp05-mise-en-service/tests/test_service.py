...
@pytest.mark.todo
def test_todo1_l_assaut_mesure_des_latences(serveur):
...
@pytest.mark.todo
def test_todo1_la_latence_monte_quand_les_clients_se_multiplient(serveur):
...
@pytest.mark.todo
def test_todo2_la_garde_refuse_au_dela_de_la_file():
    def lent(valeur):
        time.sleep(0.2)
        return valeur
...
@pytest.mark.todo
def test_todo2_la_garde_abandonne_ce_qui_traine():
